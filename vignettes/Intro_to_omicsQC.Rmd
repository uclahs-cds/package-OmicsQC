...
```{r calculate_zscores}
zscores <- zscores.from.metrics(example.qc.dataframe);
```
...
### Cutoff Method: `cosine.similarity.cutoff()`
...
```{r print_barplot, echo=FALSE, out.width='80%', fig.cap='Barplot generated by get.qc.barplot()'}
...
```{r print_heatmap, echo=FALSE, out.width='80%', fig.cap='Heatmap generated by get.qc.heatmap()'}
...
```{r print_multipanelplot, echo=FALSE, out.width='80%', fig.cap='The final multipanelplot generated'}
